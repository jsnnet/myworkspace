...
개인정보의 항목 및 수집방법
			...
			<div class="form-group" id="divPassword">
				...
				<div class="col-lg-10">
					<input type="password" class="form-control" id="mempwd" name="excludeHangul" data-rule-required="true" placeholder="패스워드" maxlength="30">
				</div>
			</div>
			<div class="form-group" id="divPasswordCheck">
				<label for="inputPasswordCheck" class="col-lg-2 control-label">패스워드 확인</label>
				<div class="col-lg-10">
					<input type="password" class="form-control" id="pwdchk" data-rule-required="true" placeholder="패스워드 확인" maxlength="30">
				</div>
			</div>
			...
			<div class="form-group" id="divPhoneNumber">
				...
				<div class="col-lg-10">
					<input type="tel" class="form-control onlyNumber" id="memphone" data-rule-required="true" placeholder="-를 제외하고 숫자만 입력하세요." maxlength="11">
				</div>
			</div>
			
			<div class="form-group" id="divAge">
				<label for="inputNickname" class="col-lg-2 control-label">나이</label>
				<div class="col-lg-10">
					<input type="text" class="form-control" id="memage" data-rule-required="true" placeholder="나이" maxlength="3">
				</div>
			</div>
			...
			<div class="form-group" id="divEmail">
				...
				<div class="col-lg-10">
					<input type="email" class="form-control" id="mememail" data-rule-required="true" placeholder="이메일" maxlength="40">
				</div>
			</div>
